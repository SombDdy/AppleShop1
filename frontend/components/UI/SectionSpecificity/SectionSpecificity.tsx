            ...
            <div className = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className = " text-neutral-400 text-start sm:text-end lg:text-start text-xs lg:text-lg font-medium">Popular</div>
                    ...
                    <div className = "flex pl-5 sm:flex-row-reverse lg:flex-row pt-6">
                        ...
                        <div className = "flex w-48 h-56 lg:w-80 lg:h-96 rounded-3xl bg-violet">
                            ...
                            <img src="images/dyson.svg" className="pt-20 px-4"/>
                        </div>
                    </div>
                </div>
                <div className = "order-2 sm:order-1 lg:order-2 lg:col-span-2 ">
                    ...
                    <div className = "mt-6 mb-1 lg:my-6 p-4 w-50 lg:w-full bg-zinc-800 rounded-3xl lg:gap-x-4 lg:inline-flex">
                        ...
                        <div className = "flex-col justify-start items-start lg:gap-3 xl:gap-5 pt-4 hidden lg:inline-flex">
                            <div>
                    ...
                    <div className="flex items-center pt-16">
                        <button className = "flex rounded-3xl px-4 py-2 lg:px-6 lg:py-3 text-stone-50 text-xs lg:text-lg font-medium   bg-violet  justify-center items-center gap-2.5 mr-8 whitespace-nowrap">ORDER NOW <Icon icon="fluent-mdl2:shop" className = "text-stone-50 w-4 h-4 lg:w-6 lg:h-6"/></button>
                        <button className = "flex rounded-3xl px-4 py-2 lg:px-6 lg:py-3 border border-stone-50 justify-center items-center gap-2.5 text-stone-50 text-xs lg:text-lg font-medium">FAVORITE <Icon icon="uit:favorite" className = "text-stone-50 w-4 h-4 lg:w-6 lg:h-6" /></button>
                    </div>
                </div>
            </div>
        </div>
